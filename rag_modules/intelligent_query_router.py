...
class IntelligentQueryRouter:
    ...
    def analyze_query(self, query: str) -> QueryAnalysis:
        ...
        # 使用LLM进行智能分析
        analysis_prompt = f"""
        作为RAG系统的查询分析专家，请深度分析以下春秋战国历史查询的特征：
        ...
        1. 查询复杂度 (0-1)：
           - 0.0-0.3: 简单信息查找（如：齐桓公是哪国人？）
           - 0.4-0.7: 中等复杂度（如：长平之战的交战双方是谁？）
           - 0.8-1.0: 高复杂度推理（如：为什么秦国能统一六国？）
        
        2. 关系密集度 (0-1)：
           - 0.0-0.3: 单一实体信息（如：孙武的生平）
           - 0.4-0.7: 实体间关系（如：孙膑和庞涓是什么关系？）
           - 0.8-1.0: 复杂关系网络（如：战国七雄之间的结盟与战争关系网络）
        ...
        {{
            ...
            "confidence": 0.85,
            "reasoning": "该查询涉及多个历史实体间的复杂关系，需要图结构推理"
        }}
        """
